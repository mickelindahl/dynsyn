...
SYNAPSE_MODELS=['STN_SNR_ampa_p3']
...
def plot_recovery(ax, revoceryTimes, relativeRecovery ):
    ...
    ax.text( 0.2, 0.35, r'$\delta_{dep}^{GPe}$',
...
frequenciesAll, steadyStateFacilitationAll = simulate_steady_state_freq(numpy.arange(1.,20.,1.), 
                                                                        load=False)
# Recovery spike
