...
from simulation_utils import simulate_network_test, simulate_network_poisson
...
def simulate_1500(params_msn_d1, params_msn_d2, params_stn, synapse_models, sim_time, seed,
    ...
    layer_dic=simulate_network_test(params_msn_d1, params_msn_d2, params_stn,
                                       synapse_models, sim_time, seed,
                                       I_e_add, threads, start_rec, 
                                       model_params)    
...
save_result_at=OUTPUT_PATH+'/simulate_1500.plk2'
if 1:
