...
mynest::Ml_Module::~Ml_Module()
  ...
  void mynest::Ml_Module::init(SLIInterpreter *i, nest::Network*)
  {
    ...
    */
    ...
    nest::register_model<izhik_cond_alpha>(nest::NestModule::get_network(),
                                                "izhik_cond_alpha");

    nest::register_model<izhik_cond_beta>(nest::NestModule::get_network(),
                                                "izhik_cond_beta");
    nest::register_model<izhik_cond_exp_mu>(nest::NestModule::get_network(),
                                                "izhik_cond_exp_mu");
    nest::register_model<izhik_cond_exp_f>(nest::NestModule::get_network(),
                                                "izhik_cond_exp_f");
    nest::register_model<my_aeif_cond_exp>(nest::NestModule::get_network(),
                                                "my_aeif_cond_exp");
    nest::register_model<my_iaf_cond_exp>(nest::NestModule::get_network(),
                                                "my_iaf_cond_exp");
    ...
    */
    nest::register_prototype_connection<DropOddSpikeConnection>(nest::NestModule::get_network(), 
                                                       "drop_odd_synapse");
    nest::register_prototype_connection<tsodyks_stocastic_connection>(nest::NestModule::get_network(),
                                                       "tsodyks_stocastic_synapse");
