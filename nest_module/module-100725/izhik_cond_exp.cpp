...
void RecordablesMap<mynest::izhik_cond_exp>::create()
{
	...
	insert_(Name("g_AMPA"),
			&mynest::izhik_cond_exp::get_y_elem_<mynest::izhik_cond_exp::State_::G_AMPA>);
	insert_(Name("g_NMDA"),
			&mynest::izhik_cond_exp::get_y_elem_<mynest::izhik_cond_exp::State_::G_NMDA>);
	...
	insert_(Name("I_AMPA"   ), &mynest::izhik_cond_exp::get_I_AMPA_);
	insert_(Name("I_NMDA"   ), &mynest::izhik_cond_exp::get_I_NMDA_);
