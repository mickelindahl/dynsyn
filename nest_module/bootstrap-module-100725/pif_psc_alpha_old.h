...
*/
  ...
  private:    
    ...
    struct Buffers_ {
      ...
      nest::AnalogDataLogger<nest::PotentialRequest> potentials;
    };
...
inline
nest::port mynest::pif_psc_alpha::connect_sender(nest::PotentialRequest& pr, nest::port receptor_type)
{
  // You should usually not change the code in this function. 
  // It confirms to the connection management system that we are able
  ...
  B_.potentials.connect_logging_device(pr);
